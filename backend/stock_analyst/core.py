# ABOUTME: Core StockAnalyst class with prompt template loading and formatting
# ABOUTME: Character-aware prompt construction for AI-driven stock analysis
