...
class LynchAnalyst:
    def __init__(self, db, api_key: Optional[str] = None, prompt_template_path: Optional[str] = None, checklist_path: Optional[str] = None):
        ...
        self.prompt_template_path = prompt_template_path or os.path.join(script_dir, "prompts", "analysis", "lynch_full_analysis.md")
        self.checklist_path = checklist_path or os.path.join(script_dir, "prompts", "analysis", "lynch_checklist.md")
    ...
    def generate_unified_chart_analysis(
        ...
        script_dir = os.path.dirname(os.path.abspath(__file__))
        prompt_path = os.path.join(script_dir, "prompts", "analysis", "chart_analysis.md")
        ...
        # Return the full narrative with embedded chart placeholders
        # The frontend will parse {{CHART:x}} placeholders and render charts inline
    ...
    def generate_filing_section_summary(
        ...
        script_dir = os.path.dirname(os.path.abspath(__file__))
        prompt_path = os.path.join(script_dir, "prompts", "summarization", "filing_section.md")
    ...
    def generate_dcf_recommendations(
        ...
        script_dir = os.path.dirname(os.path.abspath(__file__))
        prompt_path = os.path.join(script_dir, "prompts", "analysis", "dcf_analysis.md")
